...
import main.java.randoop.operation.EnumConstant;
...
import test.java.randoop.test.ClassWithInnerEnum;
import test.java.randoop.test.Coin;
import test.java.randoop.test.EnumAsPredicate;
import test.java.randoop.test.OperatorEnum;
import test.java.randoop.test.PlayingCard;
import test.java.randoop.test.SimpleEnum;
