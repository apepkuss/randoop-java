package test.java.randoop.types;
...
public class SimpleTypeTest {
  ...
  public void testNames() {
    ...
    t = new ConcreteSimpleType(test.java.randoop.types.test.Subclass.class);
  ...
  public void testConversionsToObject() {
    ...
    ConcreteType longType = new ConcreteSimpleType(long.class);
    ConcreteType shortType = new ConcreteSimpleType(short.class);
    ConcreteType subclassType = new ConcreteSimpleType(test.java.randoop.types.test.Subclass.class);
