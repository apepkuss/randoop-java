 ...
 *
 * @see main.java.randoop.types.GenericClassType
 * @see main.java.randoop.types.GenericArrayType
 * @see main.java.randoop.types.GenericSimpleType
 */
public abstract class GenericType extends GeneralType {
   ...
   * @see main.java.randoop.types.GeneralType#forType(Type)
   *
